...
<div class="container-fluid p-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.students.index') }}" class="btn btn-light btn-sm px-3 border">Kembali</a>
    </div>
        ...
        <div class="card-body p-4 p-md-5">
            <form action="{{ route('admin.students.store') }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <div class="form-text small text-neutral">Nomor ini akan menerima pesan gateway saat siswa scan absen.</div>
                    @error('parent_phone')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror
                </div>

                <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-primary px-4">Simpan & Generate QR</button>
                </div>
            </form>
        </div>
    </div>
