...
<div class="container-fluid p-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-1" style="color: #111827;">Edit Akun Pengguna</h4>
            <p class="text-neutral small mb-0">Perbarui informasi, hak akses, atau status akun pengguna.</p>
        </div>
        ...
        <div class="card-body p-4 p-md-5">
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        <label class="form-label text-neutral small fw-semibold">Alamat Email <span class="text-danger">*</span></label>
                ...
                <div class="row mb-4">
                    <div class="col-md-6 mb-3 mb-md-0">
                        <label class="form-label text-neutral small fw-semibold">Kata Sandi Baru</label>
                        <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Kosongkan jika tidak ingin mengubah sandi">
                    ...
                    <div class="col-md-8 mb-3 mb-md-0">
                        ...
                        <select class="form-select @error('school_id') is-invalid @enderror" name="school_id">
                            ...
                            @foreach($schools as $school)
                                <option value="{{ $school->id }}" {{ (old('school_id') ?? $user->school_id) == $school->id ? 'selected' : '' }}>{{ $school->npsn }} - {{ $school->name }}</option>
                            @endforeach
                        </select>
                        @error('school_id')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-4">
                        <label class="form-label text-neutral small fw-semibold">Status Akun <span class="text-danger">*</span></label>
